...
const PostModal = (props) => {
    ...
    const handleChange = (e) => {
        ...
        if (image === "" || image === undefined) {
            alert(`This file is not an image, it is a ${typeof image}`);
            return;
        }
                            ...
                            <Editor>
                                ...
                                {assetArea === 'image' ?
                                    ...
                                    <UploadImage>
                                        ...
                                        {shareImage ? (<img src={URL.createObjectURL(shareImage)} />) : null}
                                    </UploadImage>
                                    ...
                                    : assetArea === 'media' ?
                                        ...
                                        <>
                                            ...
                                            {videoLink ? <ReactPlayer width="100%" height="auto" url={videoLink} /> : null}
